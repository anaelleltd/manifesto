...
This leniancy, such as it is, should exist only for the initial bootstrapping phase. By the first  continuation evaluation, the full expectations of the member's rank should be met for approval by voters.
